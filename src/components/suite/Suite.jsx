...
const features = [
    ...
    },
    {
      ...
      title: "Invoicing",
      description:
        "Generate and send invoices to your customers, right from your phone. Collect 10X faster with Byte digital invoicing."
    },
    {
      icon: <FaBook />, 
...
const Suite = () => {
  return (
    <div className="px-4 lg:px-16 py-12">
      <h1 className="text-[54px] font-bold font-lota text-center lg:px-32">A simplified suite of tools to run a smarter business.</h1>
