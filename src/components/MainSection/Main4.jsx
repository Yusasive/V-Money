    ...
    <div className="flex flex-col lg:flex-row">
      <motion.div
        ...
        <motion.p
          ...
          variants={itemVariant}>
          Run a franchise or branch business? No problem, create sub-account for
          different branches of your business, and get access to everything
      ...
      <motion.div
        ...
        <img
          className="mx-auto "
          src="https://www.usebyte.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Faccount.e1f7aa13.png&w=640&q=75"
          alt="Main4"
        />
      </motion.div>
    </div>
